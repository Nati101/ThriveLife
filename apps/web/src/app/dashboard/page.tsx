...
/** Fixture dashboard snapshot — not computed scores. */
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Five elements from spec §8 will live here. Rings will use Full Assessment authority; Scan markers stay separate — never merged."
      />
      ...
      <div className="flex flex-wrap gap-3 text-sm">
        <Link href="/check-in" className="text-brand underline-offset-2 hover:underline">
          Daily Check-In
        </Link>
        <Link
          href="/assessments"
