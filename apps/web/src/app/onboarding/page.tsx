  ...
  return (
    <div>
      <PageHeader
        ...
        description="Scaffold for the eight-step flow (spec §7.1). Wired to real Scan / Pit Stop / Full Assessment after Phase 3–4."
      />
      ...
      >
        Age gate (18+) and consent capture land in Phase 7 / 9. This route is a
        structural placeholder so the product loop is navigable now.
      </PlaceholderPanel>
